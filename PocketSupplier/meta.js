...
function preload() {
  //sprite do player
  this.load.spritesheet("player", "assets/boneco.png",{frameWidth: 137,frameHeight: 185,});
  //pré carregamento do plano de fundo
  this.load.image("map", "assets/mapNovo.jpg");
}

function create() {
  this.add.image(400, 300, "map").setScale(1.0); //criando o plano de fundo
